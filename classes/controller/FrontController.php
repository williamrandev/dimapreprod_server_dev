...
class FrontControllerCore extends Controller
{
    ...
    public function setMedia()
    {
        ...
        $this->registerStylesheet('theme-import-css', '/assets/css/cms-page-responsive/import.css', ['media' => 'all', 'priority' => 50]);
        $this->registerStylesheet('theme-responsive', '/assets/css/responsivityLe.css', ['media' => 'all', 'priority' => 1980]);
        // $this->registerStylesheet('theme-responsive-lu', '/assets/css/responsivity2.css', ['media' => 'all', 'priority' => 1980]);
        $this->registerStylesheet('theme-responsive_page_amenagement', '/assets/css/responsive_page_amenagement_d_un_stade_.css', ['media' => 'all', 'priority' => 2400]);
        $this->registerStylesheet('theme-menue-mobile', '/assets/css/menu-mobile.css', ['media' => 'all', 'priority' => 2410]);
        $this->registerStylesheet('theme-resp-product', '/assets/css/productpage_responsive.css', ['media' => 'all', 'priority' => 51]);
        $this->registerStylesheet('theme-resp-category', '/assets/css/categorypage_responsive.css', ['media' => 'all', 'priority' => 52]);
        $this->registerStylesheet('theme-custom', '/assets/css/custom.css', ['media' => 'all', 'priority' => 1000]);
        $this->registerStylesheet('theme-ourslide', '/assets/css/slider_ourproduct.css', ['media' => 'all', 'priority' => 1100]);
        $this->registerStylesheet('theme-services', '/assets/css/cms-page/services.css', ['media' => 'all', 'priority' => 1200]);
        $this->registerStylesheet('theme-pannier', '/assets/css/pannier.css', ['media' => 'all', 'priority' => 1300]);
        $this->registerStylesheet('theme-question', '/assets/css/cms-page/question.css', ['media' => 'all', 'priority' => 1400]);
        $this->registerStylesheet('theme-youtube', '/assets/css/yout-video.css', ['media' => 'all', 'priority' => 1500]);
        $this->registerStylesheet('theme-free-quote', '/assets/css/devis_gratuits.css', ['media' => 'all', 'priority' => 1600]);
        $this->registerStylesheet('theme-questions', '/assets/css/cms-page/Sav.css', ['media' => 'all', 'priority' => 1700]);
        $this->registerStylesheet('theme-viewed', '/assets/css/similare_viewed.css', ['media' => 'all', 'priority' => 1800]);
        $this->registerStylesheet('theme-authentication', '/assets/css/authentication.css', ['media' => 'all', 'priority' => 1900]);
        $this->registerStylesheet('theme-fiche', '/assets/css/cms-page/fiche-6ans.css', ['media' => 'all', 'priority' => 2000]);
        $this->registerStylesheet('theme-sur-mesure', '/assets/css/cms-page/bache-impermeable-sur-mesure.css', ['media' => 'all', 'priority' => 2100]);
        $this->registerStylesheet('theme-le-sur-mesure', '/assets/css/cms-page/plateforme-de-surveillance-sur-mesure.css', ['media' => 'all', 'priority' => 2110]);
        $this->registerStylesheet('theme-supports', '/assets/css/cms-page/quoi-faire-avec.css', ['media' => 'all', 'priority' => 2120]);
        $this->registerStylesheet('theme-le-supports', '/assets/css/cms-page/kinogramme.css', ['media' => 'all', 'priority' => 2130]);
        $this->registerStylesheet('theme-global', '/assets/css/global.css', ['media' => 'all', 'priority' => 800]);
        $this->registerStylesheet('theme-materielasceller', '/assets/css/materielasceller.css', ['media' => 'all', 'priority' => 1950]);
        $this->registerStylesheet('theme-pedagogique', '/assets/css/cms-page/conseil.css', ['media' => 'all', 'priority' => 1960]);
        $this->registerStylesheet('theme-airsautperche', '/assets/css/airsautperche.css', ['media' => 'all', 'priority' => 1970]);
        $this->registerStylesheet('theme-colorbox', '/assets/css/colorbox.css', ['media' => 'all', 'priority' => 1980]);
        $this->registerStylesheet('theme-offre', '/assets/css/cms-page/appels-d-offres.css', ['media' => 'all', 'priority' => 1990]);
        $this->registerStylesheet('theme-mandat', '/assets/css/cms-page/paiement-par-mandat.css', ['media' => 'all', 'priority' => 2140]);
        $this->registerStylesheet('theme-sautenhauteur', '/assets/css/sautenhauteur.css', ['media' => 'all', 'priority' => 2200]);
        $this->registerStylesheet('theme-airdelancer', '/assets/css/airdelancer.css', ['media' => 'all', 'priority' => 2210]);
        $this->registerStylesheet('theme-reperage', '/assets/css/reperage.css', ['media' => 'all', 'priority' => 2220]);
        $this->registerStylesheet('theme-blog', '/assets/css/cms-page/blog-dimasport.css', ['media' => 'all', 'priority' => 2230]);
        $this->registerStylesheet('theme-gymnase', '/assets/css/cms-page/gymnase_multisport.css', ['media' => 'all', 'priority' => 2240]);
        $this->registerStylesheet('theme-animation', '/assets/css/cms-page/animation_activite.css', ['media' => 'all', 'priority' => 2250]);
        $this->registerStylesheet('theme-parraine', '/assets/css/cms-page/parraine-activite.css', ['media' => 'all', 'priority' => 2260]);
        $this->registerStylesheet('theme-organisation', '/assets/css/cms-page/organisation-evenement.css', ['media' => 'all', 'priority' => 2270]);
        $this->registerStylesheet('theme-architecte', '/assets/css/cms-page/architecte.css', ['media' => 'all', 'priority' => 2280]);
        $this->registerStylesheet('theme-collectivite', '/assets/css/cms-page/collectivite.css', ['media' => 'all', 'priority' => 2290]);
        $this->registerStylesheet('theme-voyage', '/assets/css/cms-page/voyage_dima.css', ['media' => 'all', 'priority' => 2300]);
        $this->registerStylesheet('theme-product_update', '/assets/css/product_update.css', ['media' => 'all', 'priority' => 2300]);
        $this->registerStylesheet('theme-print', '/assets/css/print.css', ['media' => 'all', 'priority' => 2400]);
        $this->registerStylesheet('theme-panier', '/assets/css/panierresponsive.css', ['media' => 'all', 'priority' => 2500]);
        $this->registerStylesheet('theme-cmspagerespo', '/assets/css/cmspageresponsive.css', ['media' => 'all', 'priority' => 2600
    ]);
        $this->registerStylesheet('theme-savrespo', '/assets/css/amenagement-stade.css', ['media' => 'all', 'priority' => 2700
    ]);
        $this->registerStylesheet('theme-savrespo', '/assets/css/cms-responsive/savresponsive.css', ['media' => 'all', 'priority' => 2700
    ]);
        $this->registerStylesheet('theme-devisrespo', '/assets/css/cms-responsive/devisgratuitresponsive.css', ['media' => 'all', 'priority' => 2800
    ]);
        $this->registerStylesheet('theme-conseilrespo', '/assets/css/cms-responsive/conseilresponsive.css', ['media' => 'all', 'priority' => 2900
    ]);
         $this->registerStylesheet('theme-livraisonrespo', '/assets/css/cms-responsive/livraisonresponsive.css', ['media' => 'all', 'priority' => 3000
    ]);
          $this->registerStylesheet('theme-moyenrespo', '/assets/css/cms-responsive/moyenpaiementresponsive.css', ['media' => 'all', 'priority' => 3010
    ]);
           $this->registerStylesheet('theme-paiementrespo', '/assets/css/cms-responsive/paiementresponsive.css', ['media' => 'all', 'priority' => 3020
    ]);
           $this->registerStylesheet('theme-lancerespo', '/assets/css/cms-responsive/aire_lancer_respo.css', ['media' => 'all', 'priority' => 3030
    ]);
           $this->registerStylesheet('theme-sauthauteurrespo', '/assets/css/cms-responsive/aire_saut_hauteur_respo.css', ['media' => 'all', 'priority' => 3040
    ]);
        $this->registerStylesheet('theme-sautpercherespo', '/assets/css/cms-responsive/aire_saut_perche_respo.css', ['media' => 'all', 'priority' => 3050
    ]);
        $this->registerStylesheet('theme-animationrespo', '/assets/css/cms-responsive/animation_activite_respo.css', ['media' => 'all', 'priority' => 3060
    ]);
        $this->registerStylesheet('theme-appelrespo', '/assets/css/cms-responsive/appel_offre_respo.css', ['media' => 'all', 'priority' => 3070
    ]);
        $this->registerStylesheet('theme-expertrespo', '/assets/css/cms-responsive/conseil_expert_respo.css', ['media' => 'all', 'priority' => 3080
    ]);
        $this->registerStylesheet('theme-developpementrespo', '/assets/css/cms-responsive/developpement_durablerespo.css', ['media' => 'all', 'priority' => 3090
    ]);
        $this->registerStylesheet('theme-materielrespo', '/assets/css/cms-responsive/materiel_sceller_respo.css', ['media' => 'all', 'priority' => 4000
    ]);
         $this->registerStylesheet('theme-dimakidrespo', '/assets/css/cms-responsive/dimakid_respo.css', ['media' => 'all', 'priority' => 4001
    ]);
         $this->registerStylesheet('theme-dimafitrespo', '/assets/css/cms-responsive/dimafit_respo.css', ['media' => 'all', 'priority' => 4002
    ]);
         $this->registerStylesheet('theme-gymnaserespo', '/assets/css/cms-responsive/gymnase_multisport_respo.css', ['media' => 'all', 'priority' => 4003
    ]);
         $this->registerStylesheet('theme-organisationrespo', '/assets/css/cms-responsive/organisation_evenement_respo.css', ['media' => 'all', 'priority' => 4004
    ]);
         $this->registerStylesheet('theme-parrainerrespo', '/assets/css/cms-responsive/parrainer_activite.css', ['media' => 'all', 'priority' => 4005
    ]);
         $this->registerStylesheet('theme-respos', '/assets/css/cms-responsive/qui_sommes_nous_respo.css', ['media' => 'all', 'priority' => 4006
    ]);
         $this->registerStylesheet('theme-respomesure', '/assets/css/surmesureresponsive.css', ['media' => 'all', 'priority' => 4007
    ]);
        ...
        $this->registerJavascript('theme-slide-cms', '/assets/js/slide-cms.js', ['position' => 'bottom', 'priority' => 50]);
        $this->registerJavascript('theme-custom', '/assets/js/custom.js', ['position' => 'bottom', 'priority' => 1000]);
        $this->registerJavascript('theme-customizer', '/assets/js/customizer.js', ['position' => 'bottom', 'priority' => 1200]);
        $this->registerJavascript('theme-menumob', '/assets/js/mobile-menu.js', ['position' => 'bottom', 'priority' => 1400]);
        $this->registerJavascript('js-custom', '/assets/js/amenagement-stade.js', ['position' => 'bottom', 'priority' => 1100]);
        $this->registerJavascript('js-colorbox', '/assets/js/jquery.colorbox-min.js', ['position' => 'bottom', 'priority' => 1200]);
        $this->registerJavascript('js-custom1', '/assets/js/custom1.js', ['position' => 'bottom', 'priority' => 1300]);
        $this->registerJavascript('js-custom2', '/assets/js/custom2.js', ['position' => 'bottom', 'priority' => 1400]);
        $this->registerJavascript('colorbox', '/themes/classic/assets/js/colorbox.js', ['position' => 'bottom', 'priority' => 1400]);
