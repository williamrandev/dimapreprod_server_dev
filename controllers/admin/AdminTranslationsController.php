...
<body>
            ...
            foreach ($mails['files'] as $mail_name => $mail_files) {
                ...
                if (array_key_exists('html', $mail_files) || array_key_exists('txt', $mail_files)) {
                    ...
                    $str_return .= '<hr><ul class="nav nav-pills">
                        <li class="active"><a href="#' . $id_html . '-' . $mail_name . '-html" data-toggle="tab">' . $this->trans('View HTML version', [], 'Admin.International.Feature') . '</a></li>
                        <li><a href="#' . $id_html . '-' . $mail_name . '-editor" data-toggle="tab">' . $this->trans('Edit HTML version', [], 'Admin.International.Feature') . '</a></li>
                        <li><a href="#' . $id_html . '-' . $mail_name . '-text" data-toggle="tab">' . $this->trans('View/Edit TXT version', [], 'Admin.International.Feature') . '</a></li>
                        </ul>';
                    // tab-content
                    ...
                    $str_return .= '<div class="tab-pane active" id="' . $id_html . '-' . $mail_name . '-html">';
                    ...
                    $str_return .= '<div class="tab-pane" id="' . $id_html . '-' . $mail_name . '-text">';
                    $str_return .= $this->displayMailBlockTxt($mail_files_txt, $obj_lang->iso_code, $mail_name, $group_name, $name_for_module);
                    $str_return .= '</div>';

                    $str_return .= '<div class="tab-pane" id="' . $id_html . '-' . $mail_name . '-editor">';
                    $str_return .= $this->displayMailEditor($mail_files_html, $obj_lang->iso_code, $mail_name, $group_name, $name_for_module, $id_html);
                    $str_return .= '</div>';
    ...
    protected function displayMailEditor(
        ...
        $name_for_module_prefix = $name_for_module ? $name_for_module . '|' : '';

        return '<textarea class="rte-mail rte-mail-' . $id_html . '-' . $mail_name . ' form-control" data-rte="' . $id_html . '-' . $mail_name . '" name="' . $group_name . '[html][' . $name_for_module_prefix . $mail_name . ']">' . $html_content . '</textarea>';
    }
