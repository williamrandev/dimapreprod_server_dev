...
<div class="new-floatbar">
  <span class="fhelp" href="#">
    <img src="/themes/default-bootstrap/img/header/floatbar1.jpg" />
    <a href="{$link->getPageLink('contact', true, NULL)|escape:'html':'UTF-8'}">{if $language.iso_code == 'fr'}Besoin d'aide ?{else}Do you need help ?{/if}</a>
  </span>
  <span class="fchat" href="#">
    <img src="/themes/default-bootstrap/img/header/floatbar2.jpg" />
    <a href="#">{if $language.iso_code == 'fr'}Conseiller en ligne{else}Online advisor{/if}</a>
  </span>
  <span class="fnotice">
    <img src="/themes/default-bootstrap/img/header/floatbar3.jpg" />
    {assign var='lang_iso' value=$language.iso_code|default:''}
    {if $language.iso_code == 'fr'}
        <a href="/fr/content/50-catalogues">
            Catalogues
        </a>
    {else}
        <a href="/en/content/50-catalogues">
            Catalogs
        </a>
    {/if}
</span>
  <span class="fsearch" href="#">
    <img class="searchfb" src="/themes/default-bootstrap/img/header/floatbar4.jpg" />
    <a href="#search_widget">{if $language.iso_code == 'fr'}Rechercher{else}Search{/if}</a>
  </span>
  <span class="ftel" href="#">
    <img src="/themes/default-bootstrap/img/header/floatbar5.jpg" />
    <a href="tel:0164400570" class="telfb">01.64.40.05.70</a>
  </span>
</div>
