...
<div class="product-line-grid">
  ...
  <div class="product-line-grid-body col-md-4 col-xs-8">
    <div class="product-line-info">
      ...
      {if (isset($product.reference) && $product.reference) || (isset($product.product_reference) && $product.product_reference)}
        <div class="product-reference">
          <p style="color: #555555; font-size: 13px; margin-top: 5px;">
            {l s='Reference' d='Shop.Theme.Checkout'}:
            {if isset($product.reference) && $product.reference}
              <span style="color: #990000;">{$product.reference}</span>
            {else}
              <span style="color: #990000;">{$product.product_reference}</span>
            {/if}
          </p>
        </div>
      {/if}
