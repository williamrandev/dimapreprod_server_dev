...
{block name='step_content'}
  <div class="js-address-form">
    ...
    >
      ...
      {* --- ÉTAPE 1 : ADRESSE DE LIVRAISON (Toujours en premier) --- *}
      <section id="delivery-address-container">
        {if $use_same_address}
          <p>
            {if $cart.is_virtual}
      ...
      {* --- ÉTAPE 2 : ADRESSE DE FACTURATION (En deuxième) --- *}
      {if !$use_same_address}
        <section id="invoice-address-container" style="margin-top: 2rem; border-top: 1px solid #ebebeb; padding-top: 1rem;">
